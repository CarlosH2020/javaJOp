 ...
 * @author Root
 */
public class Mostra_numeros extends javax.swing.JFrame {

    /**
     * Creates new form Mostra_numeros
     */
    public Mostra_numeros() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Mostra_numeros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Mostra_numeros().setVisible(true);
            }
        });
    }
